    ...
    public static int partition(ArrayList<Value> vIndice, int CAMPO_ORDENAR, int ini, int fim) {
        ...
        for (i = ini + 1; i <= fim; i++) {
            switch (CAMPO_ORDENAR) {
                ...
                case 2:
                    try {
                        if (vIndice.get(i).getPackagi().compareToIgnoreCase(pivox.getPackagi()) < 0) {
                            vIndice.set(topo, vIndice.get(i));
                            vIndice.set(i, vIndice.get(topo + 1));
                            topo++;
                        }
                ...
                case 4:
                    try {
                        if ((vIndice.get(i).getPackagi() + ":" + vIndice.get(i).getName()).compareToIgnoreCase(pivox.getPackagi() + ":" + pivox.getName()) < 0) {
                            vIndice.set(topo, vIndice.get(i));
                            vIndice.set(i, vIndice.get(topo + 1));
                            topo++;
                        }
                ...
                case 5:
                    try {
                        if ((vIndice.get(i).getPackagi() + ":" + vIndice.get(i).getSource() + ":" + vIndice.get(i).getName()).compareToIgnoreCase(pivox.getPackagi() + ":" + pivox.getSource() + ":" + pivox.getName()) < 0) {
                            vIndice.set(topo, vIndice.get(i));
                            vIndice.set(i, vIndice.get(topo + 1));
                            topo++;
                        }
                ...
                case 6:
                    try {
                        if ((vIndice.get(i).getPackagi() + ":" + vIndice.get(i).getSource()).compareToIgnoreCase(pivox.getPackagi() + ":" + pivox.getSource()) < 0) {
                            vIndice.set(topo, vIndice.get(i));
                            vIndice.set(i, vIndice.get(topo + 1));
                            topo++;
                        }
