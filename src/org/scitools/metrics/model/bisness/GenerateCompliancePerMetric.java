...
public class GenerateCompliancePerMetric {
    ...
    static double fimCasoMedianaMenorQueUm;
...
//anterior
    ...
    public Compliance getTabelaComplianceAll(String path, String nomeArquivo, int min, int tail_mediana, int wIdeal, int wReal) {
        ...
        if (mediana != -1) {
            ...
            ArrayList<double[]> listWs = new ArrayList<double[]>();
            ArrayList<double[]> listP1s = new ArrayList<double[]>();
            ArrayList<double[]> listP2s = new ArrayList<double[]>();
            ArrayList<double[]> listKs = new ArrayList<double[]>();
            ArrayList<double[]> listCPercents = new ArrayList<double[]>();
