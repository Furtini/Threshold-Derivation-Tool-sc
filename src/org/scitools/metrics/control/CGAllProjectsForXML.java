...
import org.scitools.metrics.model.bisness.GenerateTableMethodPerType;
import org.scitools.metrics.model.bisness.GenerateTablePerMethod;
import org.scitools.metrics.model.bisness.GenerateTablePerPackages;
import org.scitools.metrics.model.bisness.GenerateTablePerType;
import org.scitools.metrics.model.bisness.ReadXML;
...
public class CGAllProjectsForXML {
    ...
    public void readXmlProject(ArrayList<String> listNamesForProject, boolean ifNotText) {
        ArrayList<Metrics> listMetrics = new ArrayList<Metrics>();
        Metrics x;
    ...
    public int applyProjectsNamesList() {
        ...
        listProjectsFilesNames = new ArrayList<ArrayList<String>>();
        ArrayList<String> saida = new ArrayList<String>();
